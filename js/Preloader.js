BasicGame.Preloader = function (game) {
	BasicGame.GAME_WIDTH = 640;
	BasicGame.GAME_HEIGHT = 480;
...
BasicGame.Preloader.prototype = {
	...
	preload: function () {
		...
		this.load.image('sky', 'images/sky-dark.png');
		this.load.image('ground', 'images/platform320.png');
		this.load.image('star', 'images/star.png');
		this.load.spritesheet('dude', 'images/dude.png', 32, 48);
		this.load.spritesheet('start-button', 'images/button.png', 87, 48);

		this.load.image('timesup', 'images/timesup.png');
